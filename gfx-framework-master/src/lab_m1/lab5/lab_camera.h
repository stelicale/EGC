    ...
    class Camera
    {
     public:
        ...
        void TranslateForward(float distance)
        {
            ...
            // Translate along current forward direction (changes height as well)
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::mat4 R = glm::rotate(glm::mat4(1.0f), angle, glm::normalize(right));
            forward = glm::normalize(glm::vec3(R * glm::vec4(forward, 0.0f)));
            up      = glm::normalize(glm::vec3(R * glm::vec4(up, 0.0f)));
        }
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // Yaw around world up axis (0,1,0)
            glm::vec3 worldUp(0.0f, 1.0f, 0.0f);
            glm::mat4 R = glm::rotate(glm::mat4(1.0f), angle, worldUp);
            forward = glm::normalize(glm::vec3(R * glm::vec4(forward, 0.0f)));
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::mat4 R = glm::rotate(glm::mat4(1.0f), angle, glm::normalize(forward));
            right = glm::normalize(glm::vec3(R * glm::vec4(right, 0.0f)));
            up    = glm::normalize(glm::vec3(R * glm::vec4(up, 0.0f)));
        }
